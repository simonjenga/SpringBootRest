...
/**
 * An SQL dialect for SQLite database.
 * 
 * The abstract class <code>Dialect</code> represents a dialect of SQL implemented by a particular RDBMS.
 * Subclasses implement Hibernate compatibility with different systems.
 * 
 * For this particular case, this subclass <code>SQLiteDialect</code> represents the dialect of SQL implemented
 * by and for SQLite RDBMS.
 * 
 * @see Dialect
 * 
 * @author Simon Njenga
...
public class SQLiteDialect extends Dialect {
    ...
    */
    ...
    public String appendIdentitySelectToInsert(String insertString) {
        ...
        return new StringBuffer(insertString.length()+30).append(insertString).append("; ").append(getIdentitySelectString()).toString();
    }
    */
